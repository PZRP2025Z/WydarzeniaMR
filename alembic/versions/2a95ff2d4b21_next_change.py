...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_event_invitations_token_hash'), 'event_invitations', ['token_hash'], unique=True)
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('event_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('going', 'not_going', 'maybe', 'invited', name='participationstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
